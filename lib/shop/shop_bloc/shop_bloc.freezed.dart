...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  started,TResult Function( String itemId)?  purchaseItem,TResult Function()?  clearError,TResult Function( int cash)?  cashUpdated,TResult Function( List<GameItem> items)?  ownedItemsUpdated,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Started() when started != null:
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  started,TResult? Function( String itemId)?  purchaseItem,TResult? Function()?  clearError,TResult? Function( int cash)?  cashUpdated,TResult? Function( List<GameItem> items)?  ownedItemsUpdated,}) {final _that = this;
switch (_that) {
case _Started() when started != null:
return started();case _PurchaseItem() when purchaseItem != null:
return purchaseItem(_that.itemId);case _ClearError() when clearError != null:
